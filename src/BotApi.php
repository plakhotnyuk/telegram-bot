...
class BotApi
{
     ...
     * @throws \TelegramBot\Api\Exception
     */
    public function setWebhook($url = '', $certificate, $allowed_updates)
    {
        return $this->call('setWebhook', ['url' => $url, 'certificate' => $certificate, 'allowed_updates' => json_encode($allowed_updates)]);
    }
    ...
    public function CreateChatInviteLink($chatId, $name, $memberLimit, $createsJoinRequest)
    {
